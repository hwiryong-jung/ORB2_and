...
void MapDrawer::DrawKeyFrames(const bool bDrawKF, const bool bDrawGraph)
{
	...
	__android_log_print(ANDROID_LOG_ERROR,"MapDrawer::DrawKeyFrames()", "## vpKFs.size() : %zu", vpKFs.size());
...
void MapDrawer::DrawMapPoints()
{
	...
	__android_log_print(ANDROID_LOG_ERROR,"MapDrawer::DrawMapPoints()", "## vpMPs.size() : %zu", vpMPs.size());
