...
public class DataSetModeActivity extends Activity implements OnClickListener{
	...
	private static String PICPath="/storage/emulated/0/tum_dataset/rgbd_dataset_freiburg3_long_office_household/rgb/",
			VOCPath="/storage/emulated/0/ORBvoc.txt",
			TUMPath="/storage/emulated/0/TUM3.yaml";
